...
object GithubContributorsComposeTheme {
...
@Composable
fun GithubContributorsTheme(
    theme: GithubContributorsComposeTheme.Theme = if (isSystemInDarkTheme()) GithubContributorsComposeTheme.Theme.Dark else GithubContributorsComposeTheme.Theme.Light,
    content: @Composable () -> Unit,
) {
    val targetColors = when (theme) {
        GithubContributorsComposeTheme.Theme.Light -> LightColorPalette
        GithubContributorsComposeTheme.Theme.Dark -> DarkColorPalette
        GithubContributorsComposeTheme.Theme.NewYear -> NewYearColorPalette
    }
    ...
    val colors = WeComposeColors(
        ...
        textFieldBackground = animateColorAsState(
            targetColors.textFieldBackground,
            tween(600)
        ).value,
